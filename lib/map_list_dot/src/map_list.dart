...
import 'package:adv_basics/map_list_dot/map_list_dot.dart';
...
class MapList {
  ...
  factory MapList([dynamic jsonInput]) {
    ...
    if (jsonInput is String) {
      ...
      if (result == null) {
        throw ArgumentError('MapList must be json compatible'); // added this line - Nikitha
      }
      //return null;    //Commented by Nikitha
   ...
   */
    dynamic found = reg_mapList.firstMatch(param);
    if (found != null) {
